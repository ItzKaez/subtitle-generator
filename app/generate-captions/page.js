          ...
          <form onSubmit={handleUpload} className="space-y-6">
            ...
            <div
              className={`
                ...
                ${isUploading ? 'border-[#FF5F5F]' : 'border-gray-600 hover:border-[#FF7B7B]'}
            ...
            >
              {/* Upload Icon */}
              <svg 
                className={`w-12 h-12 mb-4 ${isUploading ? 'text-[#FF7B7B]' : 'text-gray-500'}`}
                fill="none" 
                stroke="currentColor" 
                viewBox="0 0 24 24"
              >
              ...
              <p className="text-gray-400">
                {file ? fileName : 'Drag and drop your video here or click to browse'}
              </p>
